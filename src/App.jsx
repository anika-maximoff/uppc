...
//   // DASHBOARDS
//   if (role === "patient") {
//     return <Patient onLogout={handleLogout} />;
//   }
...
export default function App() {
  ...
  if (role === "patient") return <Patient onLogout={handleLogout} />;
  if (role === "doctor")  return <Doctor  onLogout={handleLogout} />;
  if (role === "admin")   return <Admin   onLogout={handleLogout} />;

  if (page === "login")    return <Login    onLogin={handleLogin} />;
  if (page === "shop")     return <Shop     setPage={setPage} />;
  if (page === "donation") return <Donation setPage={setPage} />;
